                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('job.update', $job->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="FK_company" class="form-control" value="{{ $job->FK_company }}" id="comp_name" placeholder="Company">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="height: 150px;">
                            ...
                            <div class="col-md-9">
                                <textarea name="description" class="form-control" style="height: 150px;" id="description">{{ $job->description }}</textarea>
                            </div>                             
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            	<p class="pt-2">Previous date and time: {{ $job->start_date }}</p>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="salary" class="form-control"  value="{{ $job->salary }}" id="salary" placeholder="Salary" required>   
                            </div>                         
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="working_hours" type="text" class="form-control"  value="{{ $job->working_hours }}" id="working_hours" placeholder="Optional">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="street" type="text" class="form-control" value="{{ $job->street }}" id="street_add" placeholder="Optional">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="zipCode" type="text" class="form-control" value="{{ $job->zipCode }}" id="zip_add" placeholder="Optional">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="city" type="text" class="form-control" value="{{ $job->city }}" id="city_add" placeholder="Optional">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="country" type="text" class="form-control" value="{{ $job->country }}" id="country_add" placeholder="Optional">
                            </div>
                        </div>
